...
, 'Create Server instance': function(){
    var server = fspfs.createServer()
      , server2 = new fspfs.Server({log:false}, ['blog.3rd-Eden.com:8081']);
    
    // server 2 options test
    server2.log.should.be.false;
    server2.origins.length.should.equal(1);
    server2.origins[0].should.equal('blog.3rd-Eden.com:8081');
...
, 'Add origin': function(){
    var server = fspfs.createServer();
    server.add('google.com:80', 'blog.3rd-Eden.com:8081');
