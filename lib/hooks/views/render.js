...
module.exports = function render(relPathToView, _options, cb_view) {
		...
		_.extend(options, {locals: _.cloneDeep(options), settings: {'view engine': sails.config.views.engine.ext, 'views': sails.config.paths.views}});

		// Set up a mock request for i18n to use as context
		var req = {headers: {}};

		// Initialize i18n
		i18n.init(req, options, function() {			
